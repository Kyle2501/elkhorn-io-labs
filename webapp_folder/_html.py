...
lab_project_list = '''<style>

.project_list_wrap { display: inline-block; }
.project_list_data { margin-top: 25px; font-family: 'Mukta Malar', sans-serif; }

.project_list_data div { border-left: 4px solid #fff; padding-left: 10px; }
.project_list_data div:hover { border-left: 4px solid #444; }
.project_list_data div:hover a { color: #111; }
.project_list_data a { text-decoration: none; color: #777; }

</style>
<div class="project_list_wrap">
  <div class="project_list_data">
  <div><a href="http://agenda.elkhorn.io">Agenda</a></div>
  <div><a href="http://projects.elkhorn.io">Projects</a></div>
  <div><a href="http://accounting.elkhorn.io">Accounting</a></div>
  <div><a href="http://budget.elkhorn.io">Budget</a></div>
  <div><a href="http://payments.elkhorn.io">Payments</a></div>
  <div><a href="http://invoicing.elkhorn.io">Invoicing</a></div>
  <div><a href="http://roadmap.elkhorn.io">Roadmap</a></div>
  <div><a href="http://seasons.elkhorn.io">Seasons</a></div>
  <div><a href="http://progress.elkhorn.io">Progress</a></div>
  <div><a href="http://people.elkhorn.io">People</a></div>
  <div><a href="http://profiles.elkhorn.io">Profiles</a></div>
  <div><a href="http://status.elkhorn.io">Status</a></div>
  <div><a href="http://time.elkhorn.io">Time</a></div>
  <div><a href="http://color.elkhorn.io">Color</a></div>
  <div><a href="http://audio.elkhorn.io">Audio</a></div>
  <div><a href="http://video.elkhorn.io">Video</a></div>
  <div><a href="http://data.elkhorn.io">Data</a></div>
  <div><a href="http://events.elkhorn.io">Events</a></div>
  <div><a href="http://meeting.elkhorn.io">Meeting</a></div>
  <div><a href="http://layouts.elkhorn.io">Layouts</a></div>
  <div><a href="http://wireframe.elkhorn.io">Wireframe</a></div>
  
  
  </div><!-- . project_list_data - -->
</div><!-- . project_list_wrap - -->
'''
